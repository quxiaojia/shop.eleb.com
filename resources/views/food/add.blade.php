...
@section('contents')
    ...
    <div class="page-header">
        <h1 style="margin-left: 30%;font-size: 50px"><small>新增菜品</small></h1>
    </div>
    @include('layouts._errors')
    <form method="post" action="{{route('food.store')}}" enctype="multipart/form-data" style="margin-left: 30%">
        <div style="margin-bottom: 20px">
            <div class="input-group ">
                <span class="input-group-addon" id="basic-addon2" style="width: 100px;">菜品名:</span>
                <input type="text" name="goods_name" class="form-control"  placeholder="请输入菜品名" aria-describedby="sizing-addon2" style="width: 200%;background-color:  #FFFFCC">
            </div>
        </div>
        ...
        <div style="margin-bottom: 20px">
            <div class="input-group">
                ...
                <input type="text" name="goods_price" class="form-control" placeholder="请输入菜品价格"   aria-describedby="sizing-addon1" style="width: 200%;background-color:  #FFFFCC">
            </div>
        </div>
        ...
        <div style="margin-bottom: 20px">
            <div class="input-group">
                ...
                <input type="text" name="tips" class="form-control" placeholder="请输入提示"   aria-describedby="sizing-addon1" style="width: 200%;background-color:  #FFFFCC">
            </div>
        </div>
